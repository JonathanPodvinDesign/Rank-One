<header class="header header--yellow">
  <nav>
    ...
    <div class="nav__brand">
      <a href="index.php"><img src="img/logo-rank-one-no-baseline.svg" /></a>
    </div>
    <!-- menu -->
    <div class="nav__bar">
      <div class="nav__bar__menu">
        <ul>
          ...
          <li>
            <div><i class="fas fa-pen"></i><a href="blog.php">Blog</a></div>
          </li>
          <li>
            <div>
      ...
      <!-- icon hamburger -->
      <button class="nav__bar__hamburger">
        <span class="nav__bar__hamburger__line nav__bar__hamburger__hover-left"
          >&nbsp</span
        >
        <span class="nav__bar__hamburger__line">&nbsp</span>
        <span class="nav__bar__hamburger__line nav__bar__hamburger__hover-right"
          >&nbsp</span
        >
      </button>
    </div>
